# Jorge Saud Rosal's CV

- Email: [jorgelsaud@gmail.com](mailto:jorgelsaud@gmail.com)
- Location: Santiago, Chile (Open to Relocation)
- Website: [giorgiosaud.io](https://giorgiosaud.io/)
- LinkedIn: [giorgiosaud](https://linkedin.com/in/giorgiosaud)
- GitHub: [giorgiosaud](https://github.com/giorgiosaud)
...
# Experience
## **Customer Solutions Architect**, Modyo -- Santiago, Chile
...
## **Front End Architect**, Modyo -- Santiago, Chile
...
## **Frontend Web Developer**, Modyo -- Santiago, Chile
...
## **CTO & Full-Stack Developer**, Zonapro.net -- Puerto Ordaz, Venezuela
...
Comprehensive Model Context Protocol server for managing Modyo platform instances via AI assistants
...
## **MELI API Integration MCP**

2024 – present

Personal MCP server for secure credential management and MercadoLibre private API integration
...
Technical blog documenting real-world solutions from financial platform projects
...
## **Full-Stack Personal Apps**

Jan 2024

Side projects built with modern stack (Vercel, Supabase, React)
...
# Education
## **Universidad Católica Andrés Bello**, Engineer in Industrial Engineering -- Venezuela2002 – 2007
