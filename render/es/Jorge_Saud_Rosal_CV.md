...
- Location: Santiago, Chile (Abierto a Reubicación)
...
## **Arquitecto Front End**, Modyo -- Santiago, Chile
...
## **Desarrollador Web Frontend**, Modyo -- Santiago, Chile
...
## **CTO y Desarrollador Full-Stack**, Zonapro.net -- Puerto Ordaz, Venezuela
...
Servidor MCP integral para gestionar instancias de plataforma Modyo vía asistentes de IA
...
## **MCP Integración API MELI**

2024 – present

Servidor MCP personal para gestión segura de credenciales e integración con APIs privadas de MercadoLibre
...
Blog técnico documentando soluciones reales de proyectos de plataformas financieras
...
## **Apps Personales Full-Stack**

Ene 2024

Proyectos personales construidos con stack moderno (Vercel, Supabase, React)
...
# Educacion
## **Universidad Católica Andrés Bello**, Ingeniero in Ingeniería Industrial -- Venezuela2002 – 2007
